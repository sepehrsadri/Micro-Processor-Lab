...
; 0000 0020 TCNT0=0xD9;
	LDI  R30,LOW(217)
	OUT  0x32,R30
; 0000 0021 // Place your code here
; 0000 0022 if (PINC.2==0)
	SBIC 0x13,2
	RJMP _0x3
; 0000 0023     {
...
; 0000 0026         counter++;
	...
	ADIW R30,1
	MOVW R4,R30
; 0000 0027         PORTB=0x09;
	LDI  R30,LOW(9)
	RJMP _0xF
; 0000 0028         }
; 0000 0029     else if(counter==1)
_0x4:
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R4
...
; 0000 002B         counter++;
	...
	ADIW R30,1
	MOVW R4,R30
; 0000 002C         PORTB=0x05;
	LDI  R30,LOW(5)
	RJMP _0xF
; 0000 002D         }
; 0000 002E     else if(counter==2)
_0x6:
	LDI  R30,LOW(2)
	LDI  R31,HIGH(2)
	CP   R30,R4
...
; 0000 0030         counter++;
	...
	ADIW R30,1
	MOVW R4,R30
; 0000 0031         PORTB=0x06;
	LDI  R30,LOW(6)
	RJMP _0xF
; 0000 0032         }
; 0000 0033     else if(counter==3)
_0x8:
	LDI  R30,LOW(3)
	LDI  R31,HIGH(3)
	CP   R30,R4
...
; 0000 0047 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0048 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(15)
	OUT  0x17,R30
; 0000 0049 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 005D // Timer Period: 4/992 ms
; 0000 005E TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (1<<CS01) | (1<<CS00);
	LDI  R30,LOW(3)
	OUT  0x33,R30
; 0000 005F TCNT0=0xD9;
	LDI  R30,LOW(217)
	OUT  0x32,R30
; 0000 0060 OCR0=0x00;
	LDI  R30,LOW(0)
...
; 0000 0084 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 0085 
