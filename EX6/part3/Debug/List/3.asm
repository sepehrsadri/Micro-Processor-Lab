...
; 0000 002F // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0030 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(15)
	OUT  0x17,R30
; 0000 0031 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 0097         delay_ms(1000);
	RCALL SUBOPT_0x0
; 0000 0098         PORTB=0x09;
	LDI  R30,LOW(9)
	RCALL SUBOPT_0x1
; 0000 0099         delay_ms(500);
; 0000 009A         PORTB=0x05;
	RCALL SUBOPT_0x2
; 0000 009B         delay_ms(250);
; 0000 009C         PORTB=0x06;
	RCALL SUBOPT_0x3
; 0000 009D         delay_ms(125);
; 0000 009E         PORTB=0x0A;
	LDI  R30,LOW(10)
	OUT  0x18,R30
; 0000 009F         delay_ms(100);
	...
	LDI  R27,0
	CALL _delay_ms
; 0000 00A0         PORTB=0x09;
	LDI  R30,LOW(9)
	RCALL SUBOPT_0x3
; 0000 00A1         delay_ms(125);
; 0000 00A2         PORTB=0x05;
	RCALL SUBOPT_0x2
; 0000 00A3         delay_ms(250);
; 0000 00A4         PORTB=0x06;
	RCALL SUBOPT_0x1
; 0000 00A5         delay_ms(500);
; 0000 00A6         PORTB=0x0A;
	LDI  R30,LOW(10)
	OUT  0x18,R30
...
; 0000 00A9         delay_ms(1000);
	RCALL SUBOPT_0x0
; 0000 00AA         PORTB=0x0A;
	LDI  R30,LOW(10)
	RCALL SUBOPT_0x1
; 0000 00AB         delay_ms(500);
; 0000 00AC         PORTB=0x06;
	RCALL SUBOPT_0x4
; 0000 00AD         delay_ms(250);
; 0000 00AE         PORTB=0x05;
	RCALL SUBOPT_0x3
; 0000 00AF         delay_ms(125);
; 0000 00B0         PORTB=0x09;
	LDI  R30,LOW(9)
	OUT  0x18,R30
; 0000 00B1         delay_ms(100);
	...
	LDI  R27,0
	CALL _delay_ms
; 0000 00B2         PORTB=0x0A;
	LDI  R30,LOW(10)
	RCALL SUBOPT_0x3
; 0000 00B3         delay_ms(125);
; 0000 00B4         PORTB=0x06;
	RCALL SUBOPT_0x4
; 0000 00B5         delay_ms(250);
; 0000 00B6         PORTB=0x05;
	RCALL SUBOPT_0x1
; 0000 00B7         delay_ms(500);
; 0000 00B8         PORTB=0x09;
	LDI  R30,LOW(9)
	OUT  0x18,R30
; 0000 00B9         delay_ms(1000);
	RCALL SUBOPT_0x0
; 0000 00BA         PORTB=0x00;
	LDI  R30,LOW(0)
	OUT  0x18,R30
