...
; .FSTART _timer0_ovf_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 0022 button=PINA;
	IN   R30,0x19
	LDI  R31,0
	STS  _button,R30
	STS  _button+1,R31
; 0000 0023 if(button==0x01)
	LDS  R26,_button
	LDS  R27,_button+1
	SBIW R26,1
	BRNE _0x3
...
; 0000 0025     x=!x;
	...
	MOV  R4,R30
	CLR  R5
; 0000 0026     if(x==0){y=0x00;}
	MOV  R0,R4
	OR   R0,R5
	BRNE _0x4
	CLR  R6
	CLR  R7
; 0000 0027     if(x==1){y=0xff;}
_0x4:
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R4
...
; 0000 0032             counter--;
	...
	MOVW R8,R30
; 0000 0033         }
; 0000 0034             if(counter==1){out=0x01; n=0;}
_0x9:
_0x8:
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	...
	CLR  R10
	CLR  R11
; 0000 0035             if(counter==2){out=0x02;}
_0xA:
	LDI  R30,LOW(2)
	LDI  R31,HIGH(2)
	CP   R30,R8
	...
	BRNE _0xB
	MOVW R12,R30
; 0000 0036             if(counter==3){out=0x04;}
_0xB:
	LDI  R30,LOW(3)
	LDI  R31,HIGH(3)
	CP   R30,R8
	...
	LDI  R31,HIGH(4)
	MOVW R12,R30
; 0000 0037             if(counter==4){out=0x08;}
_0xC:
	LDI  R30,LOW(4)
	LDI  R31,HIGH(4)
	CP   R30,R8
	...
	LDI  R31,HIGH(8)
	MOVW R12,R30
; 0000 0038             if(counter==5){out=0x10;}
_0xD:
	LDI  R30,LOW(5)
	LDI  R31,HIGH(5)
	CP   R30,R8
	...
	LDI  R31,HIGH(16)
	MOVW R12,R30
; 0000 0039             if(counter==6){out=0x20;}
_0xE:
	LDI  R30,LOW(6)
	LDI  R31,HIGH(6)
	CP   R30,R8
	...
	LDI  R31,HIGH(32)
	MOVW R12,R30
; 0000 003A             if(counter==7){out=0x40;}
_0xF:
	LDI  R30,LOW(7)
	LDI  R31,HIGH(7)
	CP   R30,R8
	...
	LDI  R31,HIGH(64)
	MOVW R12,R30
; 0000 003B             if(counter==8){out=0x80; n=1;}
_0x10:
	LDI  R30,LOW(8)
	LDI  R31,HIGH(8)
	CP   R30,R8
...
; 0000 0060 // Clock value: 0/488 kHz
; 0000 0061 // Mode: Normal top=0xFF
; 0000 0062 // OC0 output: Disconnected
; 0000 0063 // Timer Period: 0/52429 s
; 0000 0064 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(5)
	OUT  0x33,R30
